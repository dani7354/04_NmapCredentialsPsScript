...
--- Get a list of all numbers in a range
--
-- @param range_start start value for range
-- @param range_end end value for range - excluded from the result!
-- @return array containing numbers within the specified range
local function numbers_in_range(range_start, range_end)
	portnumbers = {}
	index = 0
	for port = range_start, range_end,1
	do
		portnumbers[index] = port
		index = index + 1
	end
	return portnumbers
end
...
--]]
LIKELY_HTTP_PORTS = numbers_in_range(0, 2^16)
